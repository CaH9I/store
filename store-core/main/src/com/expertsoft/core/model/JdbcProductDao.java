...
public class JdbcProductDao implements ProductDao {
    ...
    private static final RowMapper<MobilePhone> mobilePhoneRowMapper = (rs, rowNum) -> new MobilePhone(
            rs.getLong("id"),
            rs.getString("model"),
    ...
    public List<MobilePhone> findAll() {
        return jdbcTemplate.query(FIND_ALL_MOBILE_PHONES, mobilePhoneRowMapper);
    }

    @Override
    public MobilePhone findById(long id) {
        return jdbcTemplate.queryForObject(FIND_MOBILE_PHONE_BY_ID, mobilePhoneRowMapper, id);
    }
    ...
    public List<MobilePhone> findByIds(Set<Long> ids) {
        ...
        params.put("ids", ids);
        return namedParameterJdbcTemplate.query(FIND_MOBILE_PHONES_BY_IDS, params, mobilePhoneRowMapper);
    }
